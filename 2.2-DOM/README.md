...
由于本章篇幅较长，故拆分为三篇编写，其他两篇链接为：

- [DOM（文档对象模型）（二）](https://github.com/stone0090/javascript-lessons/tree/master/2.2-DOM/README2.md)
- [DOM（文档对象模型）（三）](https://github.com/stone0090/javascript-lessons/tree/master/2.2-DOM/README3.md)

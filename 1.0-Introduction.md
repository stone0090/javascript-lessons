...
> 更多关于 ECMAScript 的历史可参考 [阮一峰](http://www.ruanyifeng.com/home.html) 的《ECMAScript 6 入门》：[http://es6.ruanyifeng.com/#docs/intro](http://es6.ruanyifeng.com/#docs/intro)
...
BOM最让人头疼的是没有相关的规范和标准，每个浏览器都有独有的实现，这个问题在 HTML5 中得到了解决，HTML5 致力于把很多 DOM 功能写入正式规范。
